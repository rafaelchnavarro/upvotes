...
import { UpvotesComponent } from 'app/entities/upvotes/upvotes.component';
import { UpvotesService } from 'app/entities/upvotes/upvotes.service';
import { Upvotes } from 'app/shared/model/upvotes.model';

describe('Component Tests', () => {
  describe('Upvotes Management Component', () => {
    let comp: UpvotesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UpvotesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.upvotes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
